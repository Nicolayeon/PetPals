              ...
              children: [VxSwiper.builder(
               ...
               /* Row(
                  ...
                  children: List.generate(3, (index) => homeButtons(
                    ...
                    title: index == 0 ? topCategories : index == 1 ? animals : topSeller, onPress: (){
                      ...
                      switch(index){
                        case 0:
                          ...
                          break;
                        case 1:
                          Get.to(() => CategoryDetail(title: categoriesList[1]));
                          break;
                        default:
                      }
                  }
                                ...
                                return Row(
                                  children: List.generate(
                                    ...
                                    children: [
                                      ...
                                      10.heightBox,
                                      "${featuredData[index]['p_price']}".numCurrencyWithLocale(locale: "en_MY").text.color(redColor).fontFamily(bold).size(16).make()
                                    ],
                                  ).box
                                              .white
                            ...
                            itemBuilder: (context,index) {
                              return Column(
                                ...
                                children: [
                                  ...
                                  10.heightBox,
                                  "${allproductsdata[index]['p_price']}".numCurrencyWithLocale(locale: "en_MY").text.color(redColor).fontFamily(bold).size(16).make(),
                                  10.heightBox,
                                ],
                              ).box
                                  .white
